...
Heta provides the flexibility to define your own functions. For details on how to create custom functions, refer to the [`#defineFunction`](/specifications/actions#definefunction) specification.

## Included Functions

The `qsp-functions.heta` file contains a curated list of additional functions specifically tailored for Heta platforms. These functions are not part of the [base function list](/specifications/math#list-of-functions), but they extend the platform's functionality. 
